  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in khoss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                    <td>@{{sp.id_sp}}</td>            
                    <td>@{{sp.sl}}</td>          
                ...
                <tr ng-if="!khoss || (khoss | filter: search).length == 0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group can">
                                ...
                                <div>
                                    Tên sản phẩm:
                                    <input type="text" ng-model="kho.id_sp" size="25">
                                </div>                                                         
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                              Số lượng:
                                <input type="text" ng-model="kho.sl">
                            </div>
...
<script src="/js/khocontroller.js">
