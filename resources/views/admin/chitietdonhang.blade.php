...
<!DOCTYPE html>
<html lang="en"  ng-app="myapp" ng-controller="billdetailbancontroller" ng-init="ordered()">
<head>
  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in billdetailbanss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                ...
                <tr ng-if="!billdetailbanss || (billdetailbanss | filter: search).length == 0">
...
<script src="/js/billdetailbancontroller.js">
