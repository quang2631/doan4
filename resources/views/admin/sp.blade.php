...
<!DOCTYPE html>
<html lang="en"  ng-app="myapp" ng-controller="spcontroller">
<head>
  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in sanphamss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                ...
                <tr ng-if="!sanphamss || (sanphamss | filter: search).length == 0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group can">
                                ...
                                <div>
                                    Tên xe:
                                    <input type="text" ng-model="sanpham.name" size="30">
                                </div>                                                         
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Giá:
                                <input type="number" ng-model="sanpham.unit_price" >
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                                ...
                                <select ng-model="sanpham.id_loai_sp">
                                  <option value="@{{sanpham.id}}" ng-repeat = "sanpham in loaisp" >
                                      @{{sanpham.tenloai}}
                                  </option>
                              </select>
                            </div>
                      ...
                      <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                                Nhà CC:
                                <select ng-model="sanpham.id_ncc">
                                    <option value="@{{sanpham.id}}" ng-repeat = "sanpham in ncc" >
                                        @{{sanpham.ten_ncc}}
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                              Số lượng:
                                <input type="number" ng-model="sanpham.so_luong" >
                            </div>
                        ...
                        <div class="form-group">
                            <label for="HINHANH">Ảnh</label>
                              ...
                              <div style="width:100px;height:100px" id="HINHANH">
                                    <img src="/upload/sanpham/@{{sp.image}}" alt="Ảnh" style="width:100%;height:100%" ng-model="sanpham.image">
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Mô tả:
                                <input type="text" ng-model="sanpham.mota_sp" size="60">
                            </div>
