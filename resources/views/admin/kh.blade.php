  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in khachhangss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                    <td>@{{sp.ten_kh}}</td>
                    <td>@{{sp.dia_chi}}</td>
                    <td>@{{sp.email}}</td>
                ...
                <tr ng-if="!khachhangss || (khachhangss | filter: search).length == 0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group can">
                                ...
                                <div>
                                    Tên khách hàng:
                                    <input type="text" ng-model="khachhang.ten_kh" size="25">
                                </div>                                                         
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                              Email:
                                <input type="text" ng-model="khachhang.email">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Địa chỉ:
                                <input type="text" ng-model="khachhang.dia_chi">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             SĐT:
                                <input type="text" ng-model="khachhang.sdt">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Note:
                                <input type="text" ng-model="khachhang.note">
                            </div>
