  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in newsss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                    <td>@{{sp.title}}</td>
                    <td>@{{sp.content}}</td>
                    <td>@{{sp.image}}</td>
                ...
                <tr ng-if="!newsss || (newsss | filter: search).length == 0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group can">
                                ...
                                <div>
                                    Title:
                                    <input type="text" ng-model="news.title" size="25">
                                </div>                                                         
