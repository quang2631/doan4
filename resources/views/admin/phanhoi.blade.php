  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in phanhoiss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                    <td>@{{sp.ten_ncc}}</td>
                    <td>@{{sp.diachi_ncc}}</td>
                    <td>@{{sp.email}}</td>
                ...
                <tr ng-if="!phanhoiss || (phanhoiss | filter: search).length == 0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group can">
                                ...
                                <div>
                                    Tên ncc:
                                    <input type="text" ng-model="phanhoi.ten_ncc" size="25">
                                </div>                                                         
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                              Địa chỉ:
                                <input type="text" ng-model="phanhoi.diachi_ncc">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Email:
                                <input type="text" ng-model="phanhoi.email">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             SĐT:
                                <input type="text" ng-model="phanhoi.sdt">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                              Delet:
                                <input type="text" ng-model="phanhoi.Delet">
                            </div>
