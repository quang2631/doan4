  ...
  <div class="content-wrapper" style="padding-top:5px;padding-left:25px">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr ng-repeat="sp in nhanvienss | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                    <td>@{{$index+1}}</td>
                ...
                <tr ng-if="!nhanvienss || (nhanvienss | filter: search).length == 0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group can">
                                ...
                                <div>
                                    Tên nhân viên:
                                    <input type="text" ng-model="nhanvien.ten_nhanvien" size="25">
                                </div>                                                         
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Giới tính:
                                <input type="text" ng-model="nhanvien.gioitinh">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Ngày sinh:
                                <input type="text" ng-model="nhanvien.ngaysinh">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                              SĐT:
                                <input type="text" ng-model="nhanvien.sdt">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Email:
                                <input type="text" ng-model="nhanvien.email">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group can">
                            <div>
                             Cấp bậc:
                                <input type="text" ng-model="nhanvien.capbac">
                            </div>
...
<script src="/js/nhanviencontroller.js">
